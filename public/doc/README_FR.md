...
| :------------------------ | :------------------ | :--------------------- | :--------------------- | --------- |
| Mettre le CLI au premier plan | `F1`                | `F1`                   | `F1`                   | ㅤㅤ✅    |
| Mettre les Skills au premier plan | `⌘ + 3`             | `Ctrl + 3`             | `Ctrl + 3`             | ㅤㅤ✅    |
| Agrandir / Réduire le panneau | <code>⌘ + \`</code> | <code>Ctrl + \`</code> | <code>Ctrl + \`</code> | ㅤㅤ✅    |
| -                         | -                   | -                      | -                      |           |
| Panneau latéral (D/G)         | `⌘ + CapsLock`      | `Ctrl + CapsLock`      | `Ctrl + CapsLock`      | ㅤㅤ✅    |
