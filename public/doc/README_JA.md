...
- コミットされた `.f1/` プロジェクトコンテキストマップを生成して、どの CLI も安価な共有コンテキストで起動できるようにします。
- プロジェクトごとのトグル。命令ファイル（`AGENTS.md` / `CLAUDE.md`）はコンテキストを指したままになります。

## 🚀 はじめに

1. [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=bastndev.f1) から **F1** をインストールします。
2. **`F1`** を押して **CLI Hub** パネルを開きます。
3. ランチャーからエージェントを選択します（または **Custom CLI** で独自のコマンドを実行します）。
4. アクティビティバー（**`Ctrl+3`**）から **My Skills** を開いて、スキルをインストールまたは作成します。

> エージェントを初めて起動したときに、CLI がまだ `PATH` にない場合はインストールされます。
...
| 拡張機能                                                                                                                                                                                                         | 名前                                                           | 説明                                                                                                                                                                                                                       |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [![Lynx Theme Pro](https://bastndev.gallerycdn.vsassets.io/extensions/bastndev/lynx-theme/5.0.1/1777191854738/Microsoft.VisualStudio.Services.Icons.Default)](https://open-vsx.org/extension/bastndev/lynx-theme) | [Lynx Theme Pro](https://github.com/bastndev/Lynx-Theme)       | 6つのテーマが利用可能なプロフェッショナルな拡張機能：Dark、Light、Night、Ghibli、Coffee、Kiro—アイコン統合。各テーマは、より快適な視覚体験を提供するために最適化されています。                                       |
