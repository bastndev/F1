...
**قم بتشغيل وإدارة كل واجهات سطر الأوامر الخاصة ببرمجة الذكاء الاصطناعي من لوحة واحدة في VS Code.**
...
| -                                            | -                   | -                      | -                      |        |
| منتقي النموذج (فتح/إغلاق) - [3]              | `Alt + 1`           | `Alt + 1`              | `Alt + 1`              | ㅤㅤ✅ |
| استئناف الجلسة (فتح/إغلاق) - [3]             | `Alt + 2`           | `Alt + 2`              | `Alt + 2`              | ㅤㅤ✅ |
| الاستخدام / الحالة - [3]                     | `Alt + 3`           | `Alt + 3`              | `Alt + 3`              | ㅤㅤ✅ |
| وضع PRO للمطالبة                             | `Alt + 4`           | `Alt + 4`              | `Alt + 4`              | ㅤㅤ✅ |
| وضع PLAN للمطالبة                            | `Alt + 5`           | `Alt + 5`              | `Alt + 5`              | ㅤㅤ✅ |
| -                                            | -                   | -                      | -                      |        |
...
> **[3]** تنفذ `Alt + 1/2/3` الأمر الخاص بـ CLI النشط (`/model`, `/resume`, `/usage`…، مُكيَّف حسب الوكيل) — تعمل مباشرة في الطرفية **وداخل** أداة المطالبة (Prompt). اضغط على نفس المجموعة مرة أخرى لإغلاق المنتقي الذي تم فتحه. الاستخدام/الحالة غير متاحين على كل CLI.

---

## 🚀 البدء

1. اضغط على **`F1`** لفتح لوحة **CLI Hub**.
2. اختر وكيلاً من المشغل (أو **Custom CLI** لتشغيل أمرك الخاص).
3. افتح **My Skills** من شريط النشاط (**`Ctrl+3`**) لتثبيت المهارات أو إنشائها.

> لاستخدام (**`Alt + E`**) & (**`Ctrl + 3`**) ، يجب أن يكون لديك **[Lynx Keymap Pro](https://open-vsx.org/extension/bastndev/Lynx-Keymap)** مثبتاً.
...
- تشغيل واجهات برمجة متعددة للذكاء الاصطناعي جنباً إلى جنب في أجهزة طرفية مضمنة [xterm.js](https://xtermjs.org/).
- مشغل بحث ضبابي لاختيار وكيل؛ اضغط على **F1** للانتقال مباشرة إلى اللوحة.
- أدوات مدمجة بجانب كل جلسة:
  - **المطالبة (Prompt)** — محرر غني بذكر الملفات `@`، ولصق الصور، ورقاقات المهارات، وسجل المطالبات (`↑`)، وأوضاع **PRO / PLAN**، وعلامات التدقيق الإملائي المباشر، والترجمة من المصدر→الإنجليزية قبل الإرسال.
  - **المترجم (Translator)** — ترجم أي تحديد في الجهاز الطرفي مدمجاً، مع وضع تلقائي يقرأ الإجابة بصوت عالٍ بينما لا يزال الباقي يُترجم.
...
- تثبيت المهارات من المتجر — مصادر **كل الوقت (All-time)**، **الرائجة (24h)**، **🔥 المشتعلة (Flame)**، و **الرسمية (Official)**.
...
### الطريقة 1 — الفتح السريع (Quick Open)

قم بتشغيل _Quick Open_ اعتمادًا على نظام التشغيل الخاص بك:
...
- 🔴 **[YouTube](https://www.youtube.com/@gohitx?sub_confirmation=1)** : الرمز، البرمجيات، ورؤى التطوير.
...
<div align="center">
  ...
  <br>
  <em>شكراً لجميع رعاتنا الرائعين! 💖</em><br>
...
<div align="center">
  ...
  **استمتع 🎉 — (F1) مثبت الآن!**  
  *إذا وجدت أي أخطاء أو كان لديك ملاحظات، فلا تتردد في [فتح مشكلة (issue)](https://github.com/bastndev/F1/issues/new).*

<sub>صُنع في 🇵🇪 بواسطة <a href="https://gohit.xyz">Gohit X</a> · مرخص بموجب <a href="https://github.com/bastndev/F1/blob/main/LICENSE">`MIT`</a></sub>
