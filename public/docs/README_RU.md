...
## ⌨️ Сочетания клавиш - Фокус `[`CLI Hub`]`
...
| Возобновить сессию (открыть/закрыть) - [3]  | `Alt + 2`           | `Alt + 2`              | `Alt + 2`              | ㅤㅤ✅         |
| Использование / статус - [3]                | `Alt + 3`           | `Alt + 3`              | `Alt + 3`              | ㅤㅤ✅         |
| Режим PRO Prompt                            | `Alt + 4`           | `Alt + 4`              | `Alt + 4`              | ㅤㅤ✅         |
| Режим PLAN Prompt                           | `Alt + 5`           | `Alt + 5`              | `Alt + 5`              | ㅤㅤ✅         |
| -                                           | -                   | -                      | -                      |                |
...
> **[3]** `Alt + 1/2/3` выполняют собственную команду активного CLI (`/model`, `/resume`, `/usage`…, адаптировано для агента) — они работают непосредственно в терминале **и** внутри инструмента Prompt. Нажмите ту же комбинацию снова, чтобы закрыть открытый селектор. Использование/статус доступны не на каждом CLI.
...
2. Выберите агента из списка (или **Custom CLI**, чтобы запустить свою команду).
3. Откройте **My Skills** на панели активности (**`Ctrl+3`**), чтобы установить или создать навыки.

> Для использования (**`Alt + E`**) & (**`Ctrl + 3`**) , у вас должен быть установлен **[Lynx Keymap Pro](https://open-vsx.org/extension/bastndev/Lynx-Keymap)**.
...
- Встроенные инструменты в каждой сессии:
  - **Prompt** — богатый редактор с упоминаниями файлов через `@`, вставкой изображений, чипами навыков (skills), историей промптов (`↑`), режимами **PRO / PLAN**, проверкой орфографии в реальном времени и переводом на английский перед отправкой.
  - **Translator** — переводите любое выделение в терминале прямо на месте, с автоматическим режимом, который зачитывает ответ вслух, пока остальная часть ещё переводится.
...
| -------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [![Lynx Theme Pro](https://open-vsx.org/api/bastndev/lynx-theme/5.0.0/file/icon.png)](https://open-vsx.org/extension/bastndev/lynx-theme)    | [Lynx Theme Pro](https://github.com/bastndev/Lynx-Theme)       | Профессиональное расширение с шестью доступными темами: Dark, Light, Night, Ghibli, Coffee и Kiro—с интегрированными иконками. Каждая тема оптимизирована для более приятного визуального восприятия.                          |
