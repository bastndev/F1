...
| 세션 재개 (열기/닫기) - [3]        | `Alt + 2`           | `Alt + 2`              | `Alt + 2`              | ㅤㅤ✅ |
...
> **[3]** `Alt + 1/2/3`은 활성 CLI 자체의 명령을 실행합니다(`/model`, `/resume`, `/usage`…, 에이전트별로 조정됨) — 터미널 **및** Prompt 도구 내에서 직접 작동합니다. 같은 키를 다시 누르면 열린 선택기가 닫힙니다. 사용량/상태는 모든 CLI에서 사용할 수 있는 것은 아닙니다.
...
- 모든 세션 옆에 내장된 도구:
  - **Prompt** — `@`파일 멘션, 이미지 붙여넣기, 스킬 칩, 프롬프트 기록(`↑`), **PRO / PLAN** 모드, 라이브 맞춤법 검사 및 전송 전 소스→영어 번역 기능이 있는 풍부한 편집기.
  - **Translator** — 터미널 선택 항목을 인라인으로 번역하세요. 자동 모드에서는 나머지가 번역되는 동안 답변을 소리 내어 읽어줍니다.
  - **Use** — CLI별 사용량 / 상태 보기.
  - **Keymaps** — 키보드 단축키 참조.
...
| 확장                                                                                                                                         | 이름                                                           | 설명                                                                                                                                                                                         |
| -------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [![Lynx Theme Pro](https://open-vsx.org/api/bastndev/lynx-theme/5.0.0/file/icon.png)](https://open-vsx.org/extension/bastndev/lynx-theme)    | [Lynx Theme Pro](https://github.com/bastndev/Lynx-Theme)       | 6가지 사용 가능한 테마(Dark, Light, Night, Ghibli, Coffee, Kiro)와 아이콘이 통합된 전문 확장. 각 테마는 보다 쾌적한 시각적 경험을 제공하도록 최적화되었습니다.                               |
