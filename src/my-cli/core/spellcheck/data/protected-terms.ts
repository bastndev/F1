export const PROTECTED_TERMS = new Set<string>([
	// Word
	'analizalo', 'banderitas', 'voice-tts', 'voice tts', 'play', 'cositas','autorizacion','automaticamente', 'telemetria', 'especificamente', 'inspirate',	'susténtalo', 'sustentalo', 'redireccionará', 'mobile', 'footer', 'header', 'link', 'mejoralo', 'blur', 'revisalo', 'vistaz', 'peru', 'links', 'google translate', 'dev', 'Mejorame', 'google', 'scroll', 'translate', 'hover', 'copy','Smart', 'hagamoslo', 'agregame', 'cajita', 'keymaps', 'mejorame', 'hover', 'confirmame','reset', 'design', 'full','shit','rojito','skeleton', 'styles', 'neserio','implementalo', 'previsualiza', 'bolita','bugs', 'diferenciacion', 'markdown','solucionalo','src', 'end', 'refactor', 'middle',
