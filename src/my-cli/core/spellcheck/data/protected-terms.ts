export const PROTECTED_TERMS = new Set<string>([
	...
	'autocorrect', 'typo', 'lynxjs', 'testear', 'codigo', 'prompt', 'code', 'bug', 'palito', 'mouse', 'click', 'harry', 'potter', 'ctrl','enter' , 'alt', 'skills', 'skill', '.agents', 'agents','prompts', 'refactorizacion', 'tokens','toggle', 'claude' , 'fixnow','package','feedback','emoji',
]);
