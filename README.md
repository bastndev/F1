...
| Default        | Command               | 🍎 macOS   | 🟦 Windows | 🐧 Linux   |
| -------------- | :-------------------- | :--------- | :--------- | :--------- |
| Enable/Disable | 📄 : Global Word Wrap | `F1`       | `F1`       | `F1`       |
| Enable/Disable | ✨ : AI suggestions   | `shift+F1` | `shift+F1` | `shift+F1` |
...
<div align="center">
  ...
  **Enjoy 🎉 Your (F1) are now installed!**  
  *If you find any bugs or have feedback, you can [open an issue](https://github.com/bastndev/f1/issues)*
</div>
